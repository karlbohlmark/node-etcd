...
var Client, Etcd, HttpsAgent, Watcher, _, exports,
...
Etcd = (function() {
  function Etcd(host, port, sslopts, client) {
    ...
    if (this.client == null) {
      this.client = new Client(this.hosts, this.sslopts);
    }
  }
  ...
  Etcd.prototype._prepareOpts = function(path, apiVersion, value, allOpts) {
    var clientOptions, opt, queryString, serverprotocol;
    if (apiVersion == null) {
      apiVersion = "/v2";
    }
    if (value == null) {
    ...
    serverprotocol = this.sslopts != null ? "https" : "http";
